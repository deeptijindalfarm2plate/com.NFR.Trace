...
public class Tracesignuppage {
	...
	String randomValue;
	String emailaddress = randomNumber + "01avcyghg" + "@yopmail.com";
	...
	/* X-path for companyname*/
	@FindBy(xpath = "//input[@name='companyName']")
	private WebElement cmpname1;
	...
	/* X-path for bankname*/
	@FindBy(xpath = "//input[@name='msmeNumber']")
	private WebElement msmenumber;	
...
public void myprofile() throws InterruptedException
{
	...
	Thread.sleep(2000);
	actionutil.clickOnElement(cmpname1, "comapny name is clicked");
	...
	actionutil.clickOnElement(country, "Click on country");
	actionutil.typeText(country, "United States", "Enetered the country");	
	actionutil.scrollToElement(bankname, "scrolled to bankname");
	actionutil.clickOnElement(msmenumber, "msmenumber is clicked");
	actionutil.typeText(msmenumber, "192983758890", "Enetered the msmnumber");
	actionutil.clickOnElement(bankname, "bankname is clicked");
	actionutil.typeText(bankname, "Goldmann", "Enetered the bankname");
	actionutil.clickOnElement(accountname, "accountname is clicked");
	actionutil.typeText(accountname, "Gold digger", "Enetered the accountname");
	actionutil.clickOnElement(accountnumber, "accountnumber is clicked");
	actionutil.typeText(accountnumber, "10000234500123", "Enetered the accountnumber");
