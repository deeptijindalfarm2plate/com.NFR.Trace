...
public class Tracenetasset extends Basetest2 {
	 ...
	 */
	  ...
	  public void verifytraceassests() throws InterruptedException {
		  pages.signinpage.verifysigninPage();
		   pages.loginpage.verifyLogin("300@yopmail.com", "Admin@1234");
	 	  pages.assetpage.assets();
