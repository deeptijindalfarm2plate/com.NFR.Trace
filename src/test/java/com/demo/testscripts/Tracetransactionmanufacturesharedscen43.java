...
public class Tracetransactionmanufacturesharedscen43 extends Basetest2 {
	 ...
	 */
	  ...
	  public void verifytracetransaction43() throws InterruptedException, IOException {
		  pages.signinpage.verifysigninPage();
		   pages.loginpage.verifyLogin("ldekkenq362@yopmail.com", "Admin@1234");		 
		// pages.transactionscen4.transactionobssscc();
		  pages.transactionscen4.transactionagg();
		   pages.transactionscen4.transactionobssscc1();
