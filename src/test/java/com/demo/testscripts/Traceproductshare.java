...
public class Traceproductshare extends Basetest2 {
	 ...
	 */
	  ...
	  public void verifymanufactureproduct() throws InterruptedException, IOException {
       ...
       pages.productshare.productsadd();
