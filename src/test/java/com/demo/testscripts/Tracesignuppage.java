...
public class Tracesignuppage extends Basetest2 {
	 ...
	 */
	  ...
	  public void verifysignup_signin_myprofile() throws InterruptedException {
	  pages.signinpage.verifysigninPage();
	  pages.loginpage.verifysuperadminLogin();
	  pages.signup.networkmanagment();
	  pages.signup.myprofile();
